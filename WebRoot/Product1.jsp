...
<script src="https://cdn.staticfile.org/twitter-bootstrap/4.1.0/js/bootstrap.min.js"></script>
 ...
 <link href="//netdna.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet"> 
  ...
  <div class="container-fluid">
   ...
   <!-- 产品内容 -->
   <div class="m-auto">
   <div class="text-center"><h5>产品介绍</h5></div>
   ...
   <div class="col-sm-8">${p.type }</div>
   <hr>
   <div class="col-sm-4">介绍</div>
   <div class="col-sm-8">${p.introduce }</div>
   <hr>
    <div class="col-sm-4">实物图</div>
   <div class="col-sm-8"><img alt="" src="/upload/${p.img }"  width="250" height="250"></div>
   </div>
   </div>
   </div>
   <!-- 产品内容结束 -->
