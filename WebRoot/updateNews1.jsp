...
<script src="https://cdn.staticfile.org/twitter-bootstrap/4.1.0/js/bootstrap.min.js"></script>
 ...
 <br>
 	...
 	<div class="card">
 		...
 		<div class="card-body">
 			<form action="NewsServlet?type=update3" role="form" method="post" enctype="multipart/form-data" id="updatenews" name="updatenews">
 				<input type="hidden" name="Nid" id="Nid" value="${news.id }">
 				<div class="form-group">
 					<label for="title">标题：</label>
 					<input class="form-control" type="text" value="${news.name }"  id="title" name="title" placeholder="请输入标题">
 				</div>
 				<div class="form-group">
 				...
 				<div class="form-group">
 					...
 					<textarea rows="3" cols="12" class="form-control" id="content" name="content" placeholder="请输入内容">${news.content }</textarea>
 				</div>
