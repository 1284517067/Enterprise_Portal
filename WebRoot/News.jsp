  ...
  <div class="container-fluid">
	...
	<%} 
      ...
      {%>
  		 ...
  		 <p class="navbar-text navbar-right">您好！<%=u.getUserType() %> ：<%=u.getName() %></p>
   ...
   <!-- 新闻内容 -->
   <br>
   <div class="mx-auto col-sm-6 border border-light">
   		<br>
		<h4 class="text-center">${news.name}</h4>
		...
		<img alt="" src="/upload/${news.img }" class="img-thumbnail float-center">
		</c:if>
