 ...
 <br>
	...
	<div class="col-sm-9">
 	<div class= "card">
 		...
 		<h4 class="card-title text-white">新增产品类型</h4>
 		</div>
 		<div class="card-body">
 			<form action="TypeServlet?type=addF" role="from" method="post" id="addtype" name="addtype">
 			<div class="form-group">
 				<label for="chance">请输入类型：</label>
 				<input type="text" class="form-control" id="chance" name="chance" placeholder="请输入类型名称">
 			</div>
 			<br>
 			<div class="col-sm-10">
