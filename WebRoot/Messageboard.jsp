...
<jsp:useBean id="MessageBean" type="bean.MessageBean" class="bean.MessageBean"></jsp:useBean>
   ...
   <div class="container-fluid">
    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
   	...
   	<ul class="navbar-nav navbar-pills col-sm-4" >
   		...
   		<li class="nav-item">
   		<!-- 客户留言 -->
   		<a class="nav-link active" href="SkipServlet?skip=Message" id="newsshow">在线留言</a> 
   		</li>
   		<li class="nav-item">
   		<!-- 技术支持 -->
   ...
   <div class="col-sm-8 mx-auto">
   		<div class="card">
   			<div class="card-header">
   				<form action="MessageServlet?type=add">
   				 <div class="input-group">
   				 	<label for="M">留言：</label>
   				 	<input type="text" class="from-control col-sm-10" id="M" name="M" placeholder="请输入留言">
   				 	<div class="input-group-append">
   				 		<button class="btn btn-success" type="submit">留言</button>
   				 	</div>
   				 </div>
   				</form>
   			</div>
   			<div class="card-body">
   				<c:forEach var="row" items="${Mlist }">
   					<div class="card ">
   						...
   						<br>
   						<div class=" small text-right">${row.date}</div>
   					</div>
   				</c:forEach>
   			</div>
   		</div>
