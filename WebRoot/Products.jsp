  ...
  <div class="container-fluid">
    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
   	...
   	<ul class="navbar-nav navbar-pills col-sm-4" >
   		...
   		<li class="nav-item">
   		<!-- 产品介绍 -->
   		<a class="nav-link active" href="SkipServlet?skip=Products" id="newsshow">产品</a> 
   		</li>
   		<li class="nav-item">
   		<!-- 企业介绍 -->
   ...
   <br>
	...
	<div class="col-sm-8 mx-auto">
		...
		<div class="row">
			<div class="col-sm-4">
				<img alt="" src="/upload/${row.img }" width="250" height="250">
			</div>
			<div class=" col-sm-4 m-auto">
				...
				<p>${row.introduce}</p>
				<br>
				<a href="SkipServlet?skip=product1&id=${row.id }" class="btn btn-success ">了解更多</a>
			</div>
		</div>	
		</div>
		<br>
